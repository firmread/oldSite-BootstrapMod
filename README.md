...
run two command line function at the same time  
`grunt watch` and `jekyll serve --watch`  
  
  
  
###style
for styling development via LESS located in `/less`  checkout `variables.less` and `theme.less`  
  
###content
for content development via HTML parts located in `/docs`


--- 
  
### for inspiration of how to deal with Liquid
take a loot at siteleaf.com's theme page they are all on github  
[theme page](https://github.com/siteleaf/siteleaf-themes/wiki/Siteleaf-themes-on-Github)  
[shaken grid](https://github.com/sawyerh/shaken-grid-siteleaf)
